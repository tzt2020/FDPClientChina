        ...
        if(strafeValue.get()){
            if(mc.thePlayer.fallDistance>2.5) {
                ...
                if (mc.thePlayer.moveForward != 0.0f || mc.thePlayer.moveStrafing != 0.0f) {
                    mc.thePlayer.motionX = (-MathHelper.sin(this.getDirection()) * MoveUtils.getSpeed()).toDouble();
                    mc.thePlayer.motionZ = (MathHelper.cos(this.getDirection()) * MoveUtils.getSpeed()).toDouble();
                } else {

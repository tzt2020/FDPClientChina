    ...
    public void renderOverlay() {
        ...
        if (MusicManager.INSTANCE.getCurrentTrack() != null && MusicManager.INSTANCE.getMediaPlayer() != null) {
            ...
            try {
                ...
                RenderUtil.drawArc(18 + addonX, 19 + addonY, 14, Color.BLUE.getRGB(), 180, 180 + (currentProgress * 3.6f), 4);
        ...
        if ((MusicManager.showMsg)) {
            ...
            RenderUtil.drawRect(sr.getScaledWidth() - animation, 5, sr.getScaledWidth(), 40, realpha.reAlpha(Color.BLACK.getRGB(), 0.7f));
